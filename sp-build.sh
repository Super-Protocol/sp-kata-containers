...
script -fec 'sudo -E USE_DOCKER=true CONFIDENTIAL_GUEST=yes MEASURED_ROOTFS=yes EXTRA_PKGS="openssh-server netplan.io ubuntu-minimal dmsetup ca-certificates" ./rootfs.sh "${DISTRO}"'
popd
