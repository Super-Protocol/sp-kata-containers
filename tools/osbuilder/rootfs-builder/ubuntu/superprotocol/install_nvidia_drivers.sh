...
DEBIAN_FRONTEND=noninteractive apt install -y --no-install-recommends --allow-downgrades \
    ...
    libnvidia-gl-570=570.86.15-0ubuntu1 \
    nvidia-dkms-570-open=570.86.15-0ubuntu1 \
    nvidia-kernel-common-570=570.86.15-0ubuntu1 \
    nvidia-kernel-source-570-open=570.86.15-0ubuntu1 \
    libnvidia-compute-570=570.86.15-0ubuntu1 \
    libnvidia-extra-570=570.86.15-0ubuntu1 \
    nvidia-compute-utils-570=570.86.15-0ubuntu1 \
    libnvidia-decode-570=570.86.15-0ubuntu1 \
    libnvidia-encode-570=570.86.15-0ubuntu1 \
    nvidia-utils-570=570.86.15-0ubuntu1 \
