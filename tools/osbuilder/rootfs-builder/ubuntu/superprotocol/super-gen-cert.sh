...
kubectl create secret tls docker-registry-tls --namespace super-protocol --cert=${SUPER_CERT_FILEPATH}.crt --key=${SUPER_CERT_FILEPATH}.key --dry-run=client --output=yaml > /var/lib/rancher/rke2/server/manifests/docker-registry-tls.yaml
