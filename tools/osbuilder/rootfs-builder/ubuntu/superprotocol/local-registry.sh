...
/usr/local/bin/hauler store serve registry --store /opt/hauler/store --directory /opt/hauler/registry --tls-cert=${SUPER_CERT_FILEPATH}.crt --tls-key=${SUPER_CERT_FILEPATH}.key
